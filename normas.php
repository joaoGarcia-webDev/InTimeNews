...
<main class="container-xxl">
    ...
    <p>A sua privacidade é importante para nós. É política do InTimes News respeitar a sua privacidade em relação a
        qualquer informação sua que possamos coletar no site <a href='index.php'>InTimes News</a>, e outros sites que possuímos e
        operamos.</p>
    ...
    <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos
        controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a
                href='#' target='_BLANK'>políticas de privacidade</a>. </p>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o InTimes News oferece no site e
    ...
    <ul>
        ...
        <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
                    style='color: inherit !important; text-decoration:none !important;' href='https://jogoshoje.io'>jogos
                de hoje</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os
            direitos humanos;
        </li>
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do InTimes News, de seus
    ...
    <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se
        ...
        usa em nosso site.</p>
    <p>Esta política é efetiva a partir de <strong>Novembro</strong>/<strong>2021</strong>.</p>
    ...
    <aside class="cards-content row">
        <div class="card col-sm-12 col-md-6 col-lg-3">
            <h2>Sobre Nós</h2>
            <p class="text-lora">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero facilis ipsa autem animi
                earum quod vel illum facere voluptatem mollitia. Maxime nemo nihil dolores earum possimus pariatur,
                atque itaque voluptatibus!</p>
            <a href="#" class="btn btn-primary">Saiba mais</a>
        </div>
        <div class="card col-sm-12 col-md-6 col-lg-3">
            <h2>Contato</h2>
            <p class="text-lora">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus eum excepturi
                necessitatibus eos ducimus sequi culpa unde odit incidunt adipisci alias perspiciatis saepe voluptas
                consequatur natus quis sit, impedit veniam.</p>
