    ...
    <main>
        <article>
            <section  class="container">
                <div class="row">
                    <section class="col-6 papel sombra pg1tps1">
                        <h1 class="t2">EAD</h1>
            ...
            <section  class="container pg1">
                <div class="row">
                   ...
                   <section class="col-6 ">
                    ...
                    <section class="col-6 papel sombra">
            ...
            <section class="container pg1">
                <div class="row">
                    ...
                    <section class="col-6 ">
                        <img class="d-block w-100 pg1img3 sombra" src="img/inovacao/abandono.jpg" alt="...">
                        <img class="d-block w-100 pg1img3 sombra" src="img/inovacao/alunos.png" alt="...">
                    </section>
